  ...
  return (
    <div className="bg-white p-6 md:p-8 rounded-lg shadow-lg">
      <div className="flex justify-between items-start mb-6">
        ...
        <Button onClick={handleSave}>儲存計畫</Button>
      </div>

      <div className="flex flex-col md:flex-row gap-8">
        <div className="md:w-1/3">
          <h3 className="font-bold text-lg mb-4 text-brand-dark">課程 (1-12)</h3>
          <ul className="space-y-2">
            {plan.lessons.map((lesson, index) => (
              <li key={lesson.id}>
                ...
                >
                  <span className="font-semibold">{`第 ${index + 1} 課:`}</span> {lesson.title || '未命名'}
                </button>
              </li>
            ))}
          </ul>
        ...
        <div className="md:w-2/3">
            {plan.lessons[activeLessonIndex] && (
                <div className="space-y-4">
                    <h3 className="text-2xl font-bold text-brand-dark">正在編輯課程 {activeLessonIndex + 1}</h3>
                    <div>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700">主題/主旨</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700">主要經文</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700">活動/討論點</label>
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700">教師筆記</label>
                    ...
                    <div className="mt-6 p-4 rounded-lg bg-brand-light border-l-4 border-brand-accent">
                      <h4 className="text-xl font-bold text-brand-dark mb-2">您的 AI 導師</h4>
                      ...
                      <div className="mt-4">
                        <Button 
                          ...
                          className="w-full"
                        >
                          {isGenerating ? '思考中...' : `向 ${currentPersona.name} 尋求創意`}
                        </Button>
                      </div>
                      ...
                      {idea && (
                          <div className="mt-4 p-4 bg-white border border-gray-200 rounded-md">
                            <h5 className="font-semibold mb-2 text-brand-dark">來自 {currentPersona.name} 的建議：</h5>
